...
public class ThreeLevelAdapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
    ...
    public ThreeLevelAdapter(Context context, List<MultiItemEntity> data) {
        super(data);
